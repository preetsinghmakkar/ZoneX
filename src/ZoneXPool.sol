...
contract ZoneXPool is IZoneXPool {
    ...
    constructor() {
        (factory, token0, token1, tickSpacing, fee) = IZoneXPoolDeployer(
            msg.sender
        ).parameters();
    }
    ...
    function mint(
        ...
        IZoneXMintCallback(msg.sender).zoneXMintCallback(
            amount0,
            amount1,
            data
        );
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IZoneXSwapCallback(msg.sender).zoneXSwapCallback(
                amount0,
                amount1,
                data
            );
